...
contract StakingRewards
{
    ...
    function notifyRewardAmount(uint _amount) external onlyOwner updateReward(address(0))
    {
        ...
        require(rewardRate * duration <= balanceOf[address(this)],"reward amount > balance");
    ...
    function getReward() external updateReward(msg.sender)
    {
        ...
        {
            reward[msg.sender] = 0;
            // address(this).transfer(msg.sender, rewrd);
            // payable(address(this)).transfer(msg.sender, rewrd);
            stakingToken.transfer(msg.sender, rewrd);
        }
    }
}